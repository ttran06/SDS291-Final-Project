...
author: "Roshni Patnayakuni, Olivia Handoko, Truc Tran"
date: "12/20/2019"
output: pdf_document
---
...
anova(regModel)
```
The analysis of variance table reinforces what was learned from the coefficients table. None of the coefficents have a significant effect on the response variable.
```{r}
...
Upon Assessing the conditions of linearity it seems that most but not all the conditions of linearity are fulfulled. The residual plot indicates that while the model is linear and has constant variance the residuals are not independent to the predicted Y value. The Q-Q plot indicates that the condition of normality is fufilled for the model.
